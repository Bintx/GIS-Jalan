                ...
                <form action="{{ route('regional.update', $regional->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama_regional') is-invalid @enderror"
                            id="nama_regional" name="nama_regional"
                            value="{{ old('nama_regional', $regional->nama_regional) }}" required>
                        @error('nama_regional')
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('tipe_regional') is-invalid @enderror" id="tipe_regional"
                            ...
                            <option value="Dusun"
                                {{ old('tipe_regional', $regional->tipe_regional) == 'Dusun' ? 'selected' : '' }}>Dusun
                            </option> {{-- Perubahan di sini --}}
                        </select>
                        @error('tipe_regional')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
